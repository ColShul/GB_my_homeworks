...
# Подключаем файл items.py и импортировали поля
...
class LabirintruSpider(scrapy.Spider):
    ...
    # Будем собирать информацию о книгах по теме
    # "Машинное обучение. Анализ данных"

    start_urls = ['https://www.labirint.ru/genres/3079/?page=1']
    ...
    def parse(self, response):
        ...
        if next_page:
            yield response.follow('https://www.labirint.ru/genres/3079/' + next_page, callback=self.parse)
